...
pub const COMMANDS: [&[u8]; NUM_COMMANDS] = [
  ...
  &[0x55,0x66,0x01,0x02,0x00,0x00,0x00,0x07,0x00,0u8.wrapping_sub(0x2D),0xef,0xdf], // 2  - Rotate Down  (note: manual two's complement used for -0x2D)
  &[0x55,0x66,0x01,0x02,0x00,0x00,0x00,0x07,0u8.wrapping_sub(0x2D),0x00,0x85,0x64], // 3  - Rotate Right (note: manual two's complement used for -0x2D
