...
// +---------+----+---------+---------+----+------- ... --+---------+
pub const NUM_COMMANDS: usize = 29; // update this if more commands are added
pub const HARDCODED_COMMANDS: [&[u8]; NUM_COMMANDS] = [
  &[0x55,0x66,0x01,0x01,0x00,0x00,0x00,0x08,0x01,0xd1,0x12], // Auto Center
  &[0x55,0x66,0x01,0x02,0x00,0x00,0x00,0x07,0x00,0x2D,0x3e,0xd1], // Rotate Up
  &[0x55,0x66,0x01,0x02,0x00,0x00,0x00,0x07,0x00,0u8.wrapping_sub(0x2D),0xef,0xdf], // Rotate Down
  &[0x55,0x66,0x01,0x02,0x00,0x00,0x00,0x07,0u8.wrapping_sub(0x2D),0x00,0x85,0x64], // Rotate Right
  &[0x55,0x66,0x01,0x02,0x00,0x00,0x00,0x07,0x2D,0x00,0x4b,0x54], // Rotate Left
  &[0x55,0x66,0x01,0x02,0x00,0x00,0x00,0x07,0x00,0x00,0xf1,0x24], // Stop Rotation
  ...
  &[0x55,0x66,0x01,0x00,0x00,0x00,0x00,0x0a,0x0f,0x75], // Camera Status Information
  ...
  &[0x55,0x66,0x01,0x01,0x00,0x00,0x00,0x0c,0x06,0xf2,0xae], // Set Video Output as HDMI
  &[0x55,0x66,0x01,0x01,0x00,0x00,0x00,0x0c,0x07,0xd3,0xbe], // Set Video Output as CVBS
  &[0x55,0x66,0x01,0x01,0x00,0x00,0x00,0x0c,0x08,0x3c,0x4f], // Turn Off both CVBS and HDMI Output
  &[0x55,0x66,0x01,0x00,0x00,0x00,0x00,0x15,0xD1,0x96], // Read Range from Laser Rangefinder
  &[0x55,0x66,0x01,0x02,0x00,0x00,0x00,0x80,0x01,0x00,0x0a,0xa9], // Reboot Camera
  &[0x55,0x66,0x01,0x02,0x00,0x00,0x00,0x80,0x00,0x01,0x1a,0x8a], // Reboot Gimbal
];
